...
echo "<div id='loadanswer' class=\"load\" style=\"display:none;\"></div>
</div><div id='answerSheethide'><script>$('html, body').animate({ scrollTop: 0 }, 1000);$('.hero-image').hide('slow');</script><h1>$name, you have 40 minutes. Begin.</h1>" ;
