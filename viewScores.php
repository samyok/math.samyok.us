...
echo "<br><button style='width: 50%;' onclick='window.location.reload()' class='black-hover'>Home</button><button style='width: 50%;' onclick=".'"window.location.href=\'leaderboard.php\'"'." class='black-hover'>Leaderboard</button>";
